    ...
    return (
        <div className='py-10 md:flex max-w-[1400px] mx-auto overflow-hidden'>
            <div className='flex flex-col gap-10 justify-center items-start px-10 text-white pt-[80px] flex-1'>
                <h1 className='text-3xl md:text-5xl fontHero tracking-wider'>Znajdź <span className='text-yellow-500 fontHero font-semibold'>Meble</span>, które Odzwierciedlają Twój Styl!</h1>
                <p className='text-xl'>Jesteśmy pasjonatami designu, oferującymi szeroki wybór mebli najwyższej jakości. Nasza misja polega na dostarczaniu wyjątkowych rozwiązań, które nadadzą charakter Twojemu domowi.</p>
